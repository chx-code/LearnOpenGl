...
int main() {
    ...
    Shader texShader("/home/caros/chx/learnOpenGl/shader/vertexShader/textureVertexShader.vs", 
                        "/home/caros/chx/learnOpenGl/shader/fragmentShader/textureFragmentShader.fs");

    texShader.use(); // 不要忘记在设置uniform变量之前激活着色器程序！
    glUniform1i(glGetUniformLocation(texShader.ID, "texture1"), 0); // 手动设置
    texShader.setInt("texture2", 1); // 或者使用着色器类设置
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        texShader.setFloat("mixValue", mixValue);
